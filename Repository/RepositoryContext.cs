    ...
    public partial class RepositoryContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Part>(entity =>
            {
                ...
                entity.HasMany(d => d.Doc)
                    .WithMany(p => p.Part)
                    .UsingEntity<Dictionary<string, object>>(
                        "DocumentParts",
                        l => l.HasOne<Document>().WithMany().HasForeignKey("DocID").HasConstraintName("FK_DocumentParts_Document1"),
                        r => r.HasOne<Part>().WithMany().HasForeignKey("PartID").HasConstraintName("FK_DocumentParts_Part"),
                        j =>
                        {
                            j.HasKey("PartID", "DocID");

                            j.ToTable("DocumentParts");
                        });
            });
            ...
            modelBuilder.Entity<Unit>(entity =>
            {
                ...
                entity.Property(e => e.FOD).HasColumnType("decimal(18, 4)");

                entity.Property(e => e.FOH).HasColumnType("decimal(18, 4)");

                entity.Property(e => e.FOW).HasColumnType("decimal(18, 4)");

                entity.Property(e => e.MakeFile).HasMaxLength(255);

                entity.Property(e => e.ProjectGroupID).HasMaxLength(255);

                entity.Property(e => e.ROH).HasColumnType("decimal(18, 4)");

                entity.Property(e => e.ROW).HasColumnType("decimal(18, 4)");
